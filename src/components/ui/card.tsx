...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("rounded-lg border border-border/40 bg-gradient-to-br from-card to-card/80 text-card-foreground shadow-[0_1px_3px_0_hsl(0_0%_0%/0.04),0_1px_2px_-1px_hsl(0_0%_0%/0.04)] transition-shadow duration-200", className)} {...props} />
));
